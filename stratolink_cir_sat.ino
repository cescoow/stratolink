/* Código teste para StratoLink. Implementado: Telemetria e envio de imagem;
...
static void smartDelay(unsigned long ms){ //Função para ler string do GPS e parar o cód por certo tempo
...
void displayInfo() //Função para parser da NMEA, calculo dos parâmetros do barômetro, montar e enviar a string de telemetria
{
  //String Padrão
